...
type SumClient interface {
	SumNumber(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error)
}
...
func (c *sumClient) SumNumber(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/Sum/SumNumber", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SumServer interface {
	SumNumber(context.Context, *SumRequest) (*SumResponse, error)
...
func (UnimplementedSumServer) SumNumber(context.Context, *SumRequest) (*SumResponse, error) {
...
func _Sum_SumNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SumServer).SumNumber(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Sum/SumNumber",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServer).SumNumber(ctx, req.(*SumRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Sum_SumNumber_Handler,
		},
	},
